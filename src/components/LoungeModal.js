        ...
        <>
            {modalPosition ? ( // modalPosition이 있을 때만 모달창이 뜨도록
                <div className={`checkPasswordModal ${!modalStyle ? modalStyle : 'password-incorrect'}`}
                    ...
                    {!modalStyle ? <h5>비밀번호 확인</h5> : <h5 className="password-incorrect-text"><img width="48" height="48" src={`${process.env.PUBLIC_URL}/images/warning-emoji.png`} alt="warning-emoji" />비밀번호가 일치하지 않습니다</h5>}
